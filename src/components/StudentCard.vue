...
<template>
  <article class="card">
    ...
    <div class="card-actions">
      <RouterLink class="secondary-link" :to="{ name: 'student-detail', params: { id: props.student.id } }">
        View Details
      </RouterLink>
      <button type="button" class="button-danger" @click="emit('remove', props.student.id)">Delete</button>
    </div>
  </article>
</template>
